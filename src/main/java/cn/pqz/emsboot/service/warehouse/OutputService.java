...
import cn.pqz.emsboot.entity.warehouse.Transition;
...
import cn.pqz.emsboot.mapper.TransitionMapper;
...
public class OutputService {
     ...
     */
    public void insertOutput(Integer id, Integer orderId, Integer total, String orderNum, String orderName) {
        //更新output表
        Output output = new Output();
        output.setId(id);
        ...
        //不是导入订单的情况下
        if (orderId != 0) {
            OrderList order = orderMapper.selectById(orderId);
